<?php /* Smarty version 2.6.26, created on 2010-03-07 21:46:09
         compiled from misafir/kategoriler/yazilari_listele.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'sprintf', 'misafir/kategoriler/yazilari_listele.tpl', 24, false),array('modifier', 'date_format', 'misafir/kategoriler/yazilari_listele.tpl', 39, false),)), $this); ?>
		...
		<div class="navigation">
			<span class="previous-entries">
				...
				<?php if ($this->_tpl_vars['sayfalama_lib']->is_eski_kayit_var()): ?> 
					<a href="<?php echo ((is_array($_tmp=@SAYFA_MISAFIR_32)) ? $this->_run_mod_handler('sprintf', true, $_tmp, $this->_tpl_vars['kategori_id'], $this->_tpl_vars['sayfalama_lib']->get_eski_sayfa()) : sprintf($_tmp, $this->_tpl_vars['kategori_id'], $this->_tpl_vars['sayfalama_lib']->get_eski_sayfa())); ?>
">Eski Yazılar</a>
				<?php endif; ?>
			...
			<span class="next-entries">
				...
				<?php if ($this->_tpl_vars['sayfalama_lib']->is_yeni_kayit_var()): ?> 
					<a href="<?php echo ((is_array($_tmp=@SAYFA_MISAFIR_32)) ? $this->_run_mod_handler('sprintf', true, $_tmp, $this->_tpl_vars['kategori_id'], $this->_tpl_vars['sayfalama_lib']->get_yeni_sayfa()) : sprintf($_tmp, $this->_tpl_vars['kategori_id'], $this->_tpl_vars['sayfalama_lib']->get_yeni_sayfa())); ?>
">Yeni Yazılar</a>
				<?php endif; ?>
