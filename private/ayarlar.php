...
// Meta Ayarları
define('AYAR_11', 'ci.gen.tr'); // varsayılan meta başlığı
define('AYAR_12', 'CodeIgniter PHP Framework\'ü kullanılarak hazırlanmış açık kaynak kodlu bir projedir.'); // varsayılan meta açıklama
