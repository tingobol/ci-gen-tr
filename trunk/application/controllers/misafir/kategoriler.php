...
class Kategoriler extends MY_MisafirKontroller {
	...
	function yazilari_listele($id, $sayfa = 1) {
		...
		$this->sayfalama_lib->toplam_kayit_sayisi = $this->yazi->get_adet_2($id);
		
		$data['yazilar'] = $this->yazi->get_liste_4($this->kategori->id, $this->sayfalama_lib->adet, $this->sayfalama_lib->get_limit_ilk());
		...
		$data['kategori_id'] = $this->kategori->id;
