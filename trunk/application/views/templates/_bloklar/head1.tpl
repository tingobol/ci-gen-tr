...
<script type="text/javascript" src="{$smarty.const.DIZIN_URL_2}/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="{$smarty.const.DIZIN_URL_2}/js/jquery.form.tooltip.js"></script>

<!-- SyntaxHighlighter -->
<link href="{$smarty.const.DIZIN_URL_4}/styles/shCore.css" rel="stylesheet" type="text/css" />
<link href="{$smarty.const.DIZIN_URL_4}/styles/shThemeEclipse.css" rel="stylesheet" type="text/css" />

<script src="{$smarty.const.DIZIN_URL_4}/scripts/shCore.js" type="text/javascript"></script>
<script src="{$smarty.const.DIZIN_URL_4}/scripts/shBrushPhp.js" type="text/javascript"></script>
