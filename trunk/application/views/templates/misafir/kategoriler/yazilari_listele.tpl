	...
	{/foreach}
		...
		<div class="navigation">
			...
			<span class="previous-entries">
				<a href="{$smarty.const.SAYFA_MISAFIR_32|sprintf:$kategori->id:$sayfalama_lib->get_eski_sayfa()}">Eski Yazılar</a>
			</span>
			{/if}
			
			{if $sayfalama_lib->is_yeni_kayit_var()}
			<span class="next-entries">
				<a href="{$smarty.const.SAYFA_MISAFIR_32|sprintf:$kategori->id:$sayfalama_lib->get_yeni_sayfa()}">Yeni Yazılar</a>
			</span>
			{/if}
