<div class="blok1">
	...
	<div class="entrytop">
		<div class="entry">
			<h2>Kontrol Bekleyen Yazılar</h2>
		</div>
	</div>
	...
	<div class="icerik">
		...
		<div class="ikaz">Kontrol bekleyen yazı bulunamadı.</div>
		{else}
			...
			<table id="tablo" class="tablo">
				...
				{foreach from=$yazilar->result() item=yazi}
					...
					<tr>
						...
						<td align="center"><a href="{$smarty.const.SAYFA_ADMIN_22|sprintf:$yazi->id}" title="Detaya Bak"><img src="{$smarty.const.DIZIN_URL_3}/detay.png" /></a></td>
					</tr>
